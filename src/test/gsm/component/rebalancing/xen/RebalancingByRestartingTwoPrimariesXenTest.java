...
public class RebalancingByRestartingTwoPrimariesXenTest extends AbstractRebalancingSlaEnforcementXenTest {
    ...
    public void rebalanceTest() throws InterruptedException {
        ...
        GridServiceContainer[] machine1Containers = AdminUtils.loadGSCs(gsa, 2, ZONE);
        GridServiceContainer[] machine2Containers = AdminUtils.loadGSCs(gsa2, 2, ZONE);

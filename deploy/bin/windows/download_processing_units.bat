...
@echo deleting current webuitf jar from local sgtest folder...
rmdir %LOCAL_SGPATH%\lib\webui /s /q
@echo copying webuitf jar latest to lib in local sgtest folder...
xcopy %SGTEST_CHECKOUT_FOLDER%\lib\webui %LOCAL_SGPATH%\lib\webui /s /i /y
...
/***
 * 
 * Setup: j2ee application 'simplesession-remote.ear' is deployed to JBoss AS,
...
public class JBossRemoteSpaceTest extends AbstractWebTest {
    ...
    public void beforeTest() {
        ...
        // we want to make sure pc-lab36 is available and use it
        ...
        machine.getGridServiceAgent().getProcessesDetails();
    ...
    public void test() throws IOException, InterruptedException {
        ...
        Data data = null;
        ProcessingUnit space = gsm.deploy(new SpaceDeployment("space").numberOfInstances(1));
        space.waitFor(1);
        space.waitForSpace();
        GigaSpace gigaSpace = space.getSpace().getGigaSpace();
        
        page = assertPageExists("http://" + REMOTE_HOST + ":8080/simplesession-remote");

...
public final class TemplatesCommands {
	 ...
	 * @return CLI's output
	 */
	public static String addTemplates(final String restUrl, final String templatesFolder, final boolean expectToFail) {
	 ...
	 * @return CLI's output
	 */
	public static String removeTemplate(final String restUrl, final String templateName, final boolean expectToFail) {
	 ...
	 * @return CLI's output
	 */
	public static String getTemplate(final String restUrl, final String templateName, final boolean expectToFail) {
	 ...
	 * @return CLI's output
	 */
	public static String listTemplates(final String restUrl) {
	...
	public static void removeTemplates(String restUrl, List<String> listTemplates) {
		for (String templateName : listTemplates) {
			removeTemplate(restUrl, templateName, false);
		}
	}

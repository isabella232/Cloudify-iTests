...
export export PATH=/usr/lib/jvm/java-1.6.0-openjdk/bin:$PATH
...
sed -i "1i export JAVA_HOME=/usr/lib/jvm/java-1.6.0-openjdk" setenv.sh || error_exit $? "Failed updating setenv.sh"

...
cloud {
	...
	provider {
		...
		cloudifyUrl "http://repository.cloudifysource.org/org/cloudifysource/2.5.0-RC/gigaspaces-cloudify-wrongfile"

		// Mandatory. The prefix for new machines started for servies.
		machineNamePrefix "cloudify-agent-noak-test12"
		...
		managementGroup "cloudify-manager-noak-test12"

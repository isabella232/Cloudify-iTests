...
public class AgentRestartTest extends AbstractAgentMaintenanceModeTest {
    ...
    public void testAgentRestart() throws Exception {
		...
		repetativeAssertClusterIsStable(5, TimeUnit.MINUTES, removedAfterStabilized, addedAfterStabilized);
	...
	private void repetativeAssertClusterIsStable(final long timeout, final TimeUnit unit, CountDownLatch added, CountDownLatch removed) 

...
public class ElasticSearchServiceTest extends AbstractSeleniumServiceRecipeTest {
	...
	public void beforeTest() {
		setCurrentRecipe("elasticsearch");
		super.beforeTest();
	}
	...
	public void simpleRecipeTest() throws InterruptedException {
		...
		ApplicationNode simple = appMap.getApplicationNode("elasticsearch");
		...
		assertTrue(puTreeGrid.getProcessingUnit("elasticsearch") != null);

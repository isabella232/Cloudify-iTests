...
/**
 * This test fails - JIRA GS-9203
 * 
 * @author kobi
 *
 */
public class GatewayTwoSidedTargetGWFailOverSingleObjectUnderTxnTest extends AbstractGatewayTest {
    ...
    public GatewayTwoSidedTargetGWFailOverSingleObjectUnderTxnTest() {
        if (isDevMode()) {

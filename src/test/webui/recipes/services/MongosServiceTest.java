...
public class MongosServiceTest extends AbstractSeleniumServiceRecipeTest {
	
	@Override
	@BeforeMethod(alwaysRun = true)
	public void beforeTest() {
		setCurrentRecipe("mongodb/mongos");
		super.beforeTest();
	}
	...
	public void mongosTest() throws InterruptedException {
		...
		assertTrue(mongosNode != null);
		assertTrue(mongosNode.getStatus().equals(DeploymentStatus.INTACT));

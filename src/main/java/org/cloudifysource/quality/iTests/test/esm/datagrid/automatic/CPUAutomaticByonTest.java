package org.cloudifysource.quality.iTests.test.esm.datagrid.automatic;
 ...
 *
 */
public class CPUAutomaticByonTest extends AbstractFromXenToByonGSMTest {
	...
	protected CloudifyMachineProvisioningConfig getMachineProvisioningConfig() {
		CloudifyMachineProvisioningConfig config = super.getMachineProvisioningConfig();
    ...
    private void startNewVM() throws Exception {
        ...
        //memory capacity 1000 should be configured

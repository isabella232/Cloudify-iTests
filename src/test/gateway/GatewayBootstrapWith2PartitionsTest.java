 ...
 * @since 8.0.3
 */
public class GatewayBootstrapWith2PartitionsTest extends AbstractGatewayTest {
	...
	public GatewayBootstrapWith2PartitionsTest() {
		if (isDevMode()) {
	...
	public void testBootstrap() throws Exception {
		...
		Thread.sleep(10000);
		LogUtils.log("Enabling incoming replication..");
        ...
        LogUtils.log("Verifying objects replication..");
		...
		LogUtils.log("Verifying bootstrap..");
	...
	private void deployCluster(String localGatewayName, String targetGatewayName, String puName, String spaceUrl, GridServiceManager gsm) {
		...
		if(localGatewayName.equals("ISRAEL"))
			deploySite(gsm, siteDeployment("./apps/gateway/cluster", puName, props).partitioned(2,1));
		else

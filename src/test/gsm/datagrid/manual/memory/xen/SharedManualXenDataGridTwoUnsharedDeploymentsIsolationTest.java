 ...
 * @author dank
 */
public class SharedManualXenDataGridTwoUnsharedDeploymentsIsolationTest extends AbstractXenGSMTest {

    private boolean discoveredMachineProvisioning = false;

    @Test(timeOut = DEFAULT_TEST_TIMEOUT, groups = "1", enabled = true)
    public void manualXenDataGridDeploymentTwoIndenpendentUnsharedIsolationXenMachineProvisioningTest() {
        manualXenDataGridDeploymentTwoIndenpendentUnsharedIsolationTest(getMachineProvisioningConfig());
    }
    
    @Test(timeOut = DEFAULT_TEST_TIMEOUT, groups = "1", enabled = true)
    public void manualXenDataGridDeploymentTwoIndenpendentUnsharedIsolationDiscoveredsMachineProvisioningTest() {
        manualXenDataGridDeploymentTwoIndenpendentUnsharedIsolationTest(getDiscoveredMachineProvisioningConfig());
    }

    public void manualXenDataGridDeploymentTwoIndenpendentUnsharedIsolationTest(ElasticMachineProvisioningConfig machineProvisioningConfig) {

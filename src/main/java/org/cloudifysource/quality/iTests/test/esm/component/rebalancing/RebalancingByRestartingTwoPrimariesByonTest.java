...
public class RebalancingByRestartingTwoPrimariesByonTest extends AbstractRebalancingSlaEnforcementByonTest {
	...
	public void rebalanceTest() throws InterruptedException, TimeoutException {
		...
		GridServiceAgent[] agents = startNewByonMachines(getElasticMachineProvisioningCloudifyAdapter(), 2, AbstractFromXenToByonGSMTest.OPERATION_TIMEOUT, TimeUnit.MILLISECONDS);
		...
		RebalancingTestUtils.enforceSlaAndWait(rebalancing, pu, AbstractFromXenToByonGSMTest.OPERATION_TIMEOUT*2, TimeUnit.MILLISECONDS);

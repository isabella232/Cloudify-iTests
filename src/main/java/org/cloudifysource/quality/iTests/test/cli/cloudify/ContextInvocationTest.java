...
public class ContextInvocationTest extends AbstractLocalCloudTest {
	...
	public void testInvokeCommandFromServiceContext() throws IOException, InterruptedException {
		...
		AbstractTestSupport.assertTrue("Instances of '" + absolutePUName + "' service were not found",
		...
		AbstractTestSupport.assertTrue("Did not find expected custom command response from all instances", result.contains("[hello from 1, hello from 1]"));

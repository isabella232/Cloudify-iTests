...
${DEPLOY_ROOT_BIN_DIR}/../../bin/generate-report-cmd.sh ${SUITE_TYPE} ${BUILD_NUMBER} ${SUITE_NAME} ${MAJOR_VERSION} ${MINOR_VERSION} ${DEPLOY_ROOT_BIN_DIR} ${BUILD_LOG_URL} ${MAVEN_REPO_LOCAL}

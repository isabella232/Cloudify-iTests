 ...
 * @since 8.0.3
 */
public class GatewayCleanRoutingSchemaTest extends AbstractGatewayTest {
    ...
    public GatewayCleanRoutingSchemaTest() {
        if (isDevMode()) {
    ...
    public void test() throws Exception {
        ...
        targets = new GigaSpace[2];
        targets[0] = gigaSpace1;
        targets[1] = gigaSpace3;
    ...
    private void initialize() {
        ...
        props.put("localClusterUrl", "jini://*/*/nySpace?groups=" + group3);
        props.put("gatewayLookupGroup", UUID.randomUUID().toString());

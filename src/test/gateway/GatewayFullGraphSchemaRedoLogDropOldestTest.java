 ...
 * @since 8.0.3
 */
public class GatewayFullGraphSchemaRedoLogDropOldestTest extends AbstractGatewayTest {
    ...
    public GatewayFullGraphSchemaRedoLogDropOldestTest() {
        if (isDevMode()) {
    ...
    private void testBootstrapAfterSiteAndGWIsDown() throws Exception {
        ...
        log("bootstrapping NY site with block-operation");

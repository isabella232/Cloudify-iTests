 ...
 * Deploy insecure space 'A' partitioned 1,1 
 * Deploy secure space 'B' partitioned 1,1 
 * fill 'A' with 1000 'SpaceMessage' objects
 *
 * Tests: test 'space copy move' from 'A' to 'B' with good credentials / insufficient privileges
 ...
 *
 */
public class CliSecuritySpaceCopyMoveFromInsecureToSecureTest extends CliSecurityAbstractSpaceTest {
    ...
    public void beforeTest() {
        ...
        datagrid1 = gsm.deploy(new SpaceDeployment("A").partitioned(1, 1).maxInstancesPerVM(1).secured(false));
    ...
    @Test(timeOut = DEFAULT_TEST_TIMEOUT, groups = "1")
    public void testSpaceCopyMoveWithInsufficientPrivileges() {
        String[] args = { 
                "-user", "Allen",
                "-password", "kangaroo",
                "space", "copy", 
        ...
        regex = "User \\[Allen\\] lacks \\[Write\\] privileges";
        assertEquals("Testing: " + regex, 1, CliUtils.patternCounter(regex, mainOutput));

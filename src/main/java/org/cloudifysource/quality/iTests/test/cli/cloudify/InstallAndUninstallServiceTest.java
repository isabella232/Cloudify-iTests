...
public class InstallAndUninstallServiceTest extends AbstractLocalCloudTest {
	...
	void testRestApiInstall(String serviceName, String servicePath) throws IOException, InterruptedException{
		...
		AbstractTestSupport.repetitiveAssertTrue("Processing unit: " + absolutePUName + " was not found", new RepetitiveConditionProvider() {
		...
		AbstractTestSupport.assertTrue("Processing unit :" + absolutePUName + " Was not found", processingUnit != null);
		AbstractTestSupport.repetitiveAssertTrue("No instance of: " + absolutePUName + " is null.", new RepetitiveConditionProvider() {
            ...
            public boolean getCondition() {
                ...
                , 20000);
        AbstractTestSupport.assertTrue("Instance of '" + absolutePUName + "' service was not found",
                processingUnit != null &&

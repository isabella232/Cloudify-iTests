...
public class HibernateTransactionalGigaMapCacheProviderTest extends AbstractTest {
    ...
    public void setup() throws IOException, InterruptedException {
        ...
        hsqldbProcessId = DBUtils.loadHSQLDB(machine, "TransactionalGigaMapCacheProvider", dbPort);

        String location = "/test/cache/secondlevelcache/resources/txn-gigamap-hibernate-applicationcontext.xml";

 ...
 * 
 * TEST (7) Machine GSC Failure and recovery
 * 
 * Start
 ...
 * g. Kill -9 GSC B1, GSC B2, GSC B3, and GSC B4
 ...
 * i. Start GSC B1, GSC B2, GSC B3, GSC B4
 *    Space instances are started on B1, B2, B3 and/or B4
 * j. 2 clusters are available, 16 spaces total
 */
public class FourMachineGscFailureAndRecoveryTest extends AbstractTest {
	...
	private void killGSCsOnMachine(Machine machine, boolean intact) {
	...
	//Kill -9 GSC B1, GSC B2, GSC B3, and GSC B4
	//Space instances from B1, B2, B3, and B4 are not re-deployed because of max-per-machine.
	private void killGSCsOnMachineB() {
		log("Kill -9 GSC B1, GSC B2, GSC B3, and GSC B4");
	...
	//Start GSC B1, GSC B2, GSC B3, GSC B4
	//Space instances are started on B1, B2, B3 and/or B4
	private void startGSCsOnMachineB() throws Exception {
		
		log("Start GSC B1, GSC B2, GSC B3, GSC B4");

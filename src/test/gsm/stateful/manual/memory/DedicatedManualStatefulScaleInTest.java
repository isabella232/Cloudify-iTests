...
public class DedicatedManualStatefulScaleInTest extends AbstractGsmTest {
    ...
    public void testElasticStatefulProcessingUnitDeployment() throws IOException {    	
        ...
        // request 2 gsc be removed
        pu.scale((new ManualCapacityScaleConfigurer().
                memoryCapacity(512, MemoryUnit.MEGABYTES).create()));
        
        int expectedNumberOfContainersAfterScaleIn = 2;
        GsmTestUtils.waitForScaleToCompleteIgnoreCpuSla(pu, expectedNumberOfContainersAfterScaleIn, OPERATION_TIMEOUT);

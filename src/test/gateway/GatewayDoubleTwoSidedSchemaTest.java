 ...
 * @since 8.0.3
 */
public class GatewayDoubleTwoSidedSchemaTest extends AbstractGatewayTest {
    ...
    public GatewayDoubleTwoSidedSchemaTest() {
        if (isDevMode()) {
    ...
    public void test() throws Exception {
        ...
        targets[0] = gigaSpace3;
        
        log("case #" + ++caseNum + " writeNotExpectingReplication");
        writeNotExpectingReplication(gigaSpace2, targets, false);
        assertCleanSites(spaces, admins);
        
        log("case #" + ++caseNum + " writeMultipleNotExpectingReplication");
        writeMultipleNotExpectingReplication(gigaSpace2, targets, false);
        assertCleanSites(spaces, admins);
        
        log("case #" + ++caseNum + " updateNotExpectingReplication");
        updateNotExpectingReplication(gigaSpace2, targets, false);
        assertCleanSites(spaces, admins);
        
        log("case #" + ++caseNum + " updateMultipleNotExpectingReplication");
        updateMultipleNotExpectingReplication(gigaSpace2, targets, false);
        assertCleanSites(spaces, admins);
    ...
    private void initialize() {
        ...
        props.put("targetGatewayDiscoveryPort", "10001");
        props.put("targetGatewayLrmiPort", "7000");
        deployGateway(gsm3, siteDeployment("./apps/gateway/gateway-components", "NY", props));
        props.clear();

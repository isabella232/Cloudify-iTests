package org.cloudifysource.quality.iTests.framework.utils.xen;
...
import org.cloudifysource.quality.iTests.framework.utils.TeardownUtils;
...
public class AbstractXenGSMTest extends AbstractTestSupport {
    ...
    private void startFirstVM() {
		...
		try {
			LogUtils.log("Starting first VM");
            ...
            LogUtils.log("Started first VM on "+gsa.getMachine().getHostAddress());

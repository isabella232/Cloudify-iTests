...
JAVA_32_URL="http://repository.cloudifysource.org/com/oracle/java/1.6.0_32/wrongurl.bin"
JAVA_64_URL="http://repository.cloudifysource.org/com/oracle/java/1.6.0_32/wrongurl.bin"

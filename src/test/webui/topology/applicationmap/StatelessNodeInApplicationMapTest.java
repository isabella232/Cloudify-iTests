...
public class StatelessNodeInApplicationMapTest extends AbstractSeleniumTest {
	...
	public void webAppNodeTest() throws InterruptedException {
		...
		assertTrue(testNode.getPuType().equals("STATELESS"));
		...
		assertTrue(testNode.getxPosition() == 1);

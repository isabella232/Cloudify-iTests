 ...
 *
 */
public class CliSecurityPudeployTest extends CliSecurityAbstractDeployTest {
    ...
    public void testBadCredentials() {
        ...
        assertNull(admin.getProcessingUnits().waitFor("datagrid", 30, TimeUnit.SECONDS));

...
$JAVA_HOME/bin/java -jar logstash-1.1.13.jar agent -f /tmp/byon/gs-files/upload/cloudify-overrides/config/logstash/logstash-shipper.conf -l ~/logstash/logs/logstash-shipper-log.txt&

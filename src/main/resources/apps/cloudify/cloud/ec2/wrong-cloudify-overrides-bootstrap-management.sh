...
echo Downloading cloudify overrides from $GIGASPACES_OVERRIDES_LINK.wrong.tar.gz
wget -q $GIGASPACES_OVERRIDES_LINK.wrong.tar.gz -O $WORKING_HOME_DIRECTORY/gigaspaces_overrides.tar.gz || error_exit $? 105 "Failed downloading cloudify overrides"

...
public class CliUtils {
    ...
    private static final String REQUIERED_ARGUMENT = "config/tools/gs_cli.config";
    ...
    public static void assertCountInTarget(IJSpace target, int expected, Object tmpl)
        ...
        try {
            ...
            InactiveSpaceException firstCause = (InactiveSpaceException) ignore
                    .getMajorityCause();
    ...
    private static void handleInactiveSpaceException(IJSpace target,
            int expectedCount, InactiveSpaceException ignore) throws Exception {
